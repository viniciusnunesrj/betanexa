...
export const Topbar: React.FC<TopbarProps> = ({ onOpenMobileMenu, onNavigate }) => {
  ...
  const xpPercentage = Math.min(100, Math.round((user.experience / user.maxExperience) * 100));
              ...
              <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-[#0e0e17] border border-white/15 p-2 shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-150">
                ...
                <div className="pt-2 border-t border-white/10 space-y-1">
                  <button
                    ...
                    className="w-full text-center py-1.5 rounded-lg bg-white/5 hover:bg-cyan-500/20 text-xs font-mono text-cyan-300 transition-colors"
                  >
                    Ver Perfil Completo
                  </button>
